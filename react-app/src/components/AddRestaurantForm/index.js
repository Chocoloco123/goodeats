...
const AddRestaurantForm = () => {
  ...
  useEffect(() => {
    ...
    if (zipcode.length < 5 || zipcode.length > 5 || !zipcode || zipcode.trim() === '') validationErrors.push("A zipcode is required. Please submit a valid 5 digit zip code")
    if (!+zipcode || zipcode.trim() === '') validationErrors.push("Please submit digits only for zip code")
